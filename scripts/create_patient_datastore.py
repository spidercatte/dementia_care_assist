#!/usr/bin/env python3
"""
Creates a Vertex AI Search datastore for patient profiles and imports documents from GCS.
Called by deploy_patient_search.sh — reads config from environment variables.
...
DATASTORE_ID = os.environ.get("VERTEX_PATIENT_DATASTORE_ID", "dementia-care-patients")
GCS_BUCKET = os.environ["GCS_BUCKET"]
GCS_PREFIX = os.environ.get("GCS_PREFIX", "patients")
...
def create_datastore() -> None:
    ...
    datastore = discoveryengine.DataStore(
        display_name="Dementia Care Patient Profiles",
